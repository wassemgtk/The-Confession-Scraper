...
class RevealWordsOfPosts(object):
    ...
    def __init__(self, page_id):
        ...
        self.file_new = '../data/%s_output/%s_PostsSentiment_singleWords.csv' % (self.page_id, self.page_id)
    ...
    def getLiwcWords(self):
        ...
        with open(self.file, 'rb') as csvfile:
          ...
          for row in confessions:
            ...
            alle.append(single_status_message)
            num_processed +=1
          alles = (' ').join(alle)
          new = LIWC_Index_Count()
          count_whole_corpus = new.category_matches(alles, ['Posemo', 'Negemo', 'Work'])
